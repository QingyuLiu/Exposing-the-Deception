...
unet_dict = {
    "vanilla": (U_Net, None),
    "noresidual": (U_Net_no_residual, None),
    "single": (U_Net_single, None),
    "residual_c1": (U_Net_residual_c, [1, 2, 3]),
    "residual_c2": (U_Net_residual_c, [2, 3]),
    "residual_c3": (U_Net_residual_c, [3]),
}